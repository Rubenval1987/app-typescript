...
const turmaA = ['Pedro', 'Thiago', 'João'];
const turmaB = ['Fernando', 'Patrícia', 'Fontinelle', ...turmaA];
...
const tupla1 = [1, 'abcde', false];
function tuplaParametro1(a, b, c) {
    console.log(`1) ${a} - ${b} - ${c}`);
}
tuplaParametro1(...tupla1);
//Operedor rest/spread em tuplas
const tupla2 = [30, 'cdefg', true];
function tuplaParametro2(...param) {
...
const dobro = (valor) => valor * 2; //Trocando o "var" por "const"
